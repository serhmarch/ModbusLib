...
> - FC08 diagnostics is represented by dedicated functions per subfunction
> (`cDiagnosticsReturnQueryData`, `cDiagnosticsRestartCommunicationsOption`, etc.)
> instead of one generic diagnostics call.
...
> - `cCreateModbusDevice(...)` now includes callback slots for all enabled diagnostics subfunctions

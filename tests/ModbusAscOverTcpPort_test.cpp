...
class ModbusAscOverTcpPortTestHelper : public ModbusAscOverTcpPort
{
public:
    ModbusAscOverTcpPortTestHelper(bool blocking = true) : ModbusAscOverTcpPort(blocking) {}
...
// Test Fixture for ModbusAscOverTcpPort
class ModbusAscOverTcpPortTest : public ::testing::Test
{
protected:
    ModbusAscOverTcpPortTestHelper *port;
...
TEST_F(ModbusAscOverTcpPortTest, InitializationDefault)
{
    port = new ModbusAscOverTcpPortTestHelper();
    
    EXPECT_EQ(port->type(), Modbus::ASCvTCP);
...
TEST_F(ModbusAscOverTcpPortTest, InitializationBlockingMode)
{
    ModbusAscOverTcpPortTestHelper *portBlocking = new ModbusAscOverTcpPortTestHelper(true);
    EXPECT_TRUE(portBlocking->isBlocking());
    delete portBlocking;

    ModbusAscOverTcpPortTestHelper *portNonBlocking = new ModbusAscOverTcpPortTestHelper(false);
    EXPECT_FALSE(portNonBlocking->isBlocking());
    EXPECT_TRUE(portNonBlocking->isNonBlocking());
    delete portNonBlocking;
}

TEST_F(ModbusAscOverTcpPortTest, InitializationBasic)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, HostConfiguration)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, PortConfiguration)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, TimeoutConfiguration)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, ServerModeConfiguration)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, OpenMethodClearsChangedFlag)
{
    auto *ascTcpPort = new ModbusAscOverTcpPort(true);
    
    ascTcpPort->setHost("somethingnonexisting.plc");
    EXPECT_TRUE(ascTcpPort->isChanged());    
    auto status = ascTcpPort->open();
    EXPECT_TRUE(Modbus::StatusIsBad(status));
    EXPECT_FALSE(ascTcpPort->isChanged());    
    delete ascTcpPort;
}
...
TEST_F(ModbusAscOverTcpPortTest, WriteBufferConstructsAsciiFrameAndReturnsGood)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, WriteBufferReadHoldingRegisters)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, WriteBufferWriteSingleCoil)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, WriteBufferZeroLengthData)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, WriteBufferLargeData)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, WriteBufferOverflow)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, ReadBufferValidFrame)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, ReadBufferReadHoldingRegistersResponse)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, ReadBufferExceptionResponse)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, ReadBufferTooSmallFrame)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, ReadBufferMissingColonRaises)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, ReadBufferMissingCrlfRaises)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, ReadBufferWrongLrcRaises)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, ReadBufferMinimalValidFrame)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, ReadBufferInvalidAsciiCharacters)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, CompleteRequestResponseCycle)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, LrcCalculationConsistency)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, DifferentDataSizesLrcValidation)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, DefaultSettings)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, AsciiConversionRoundtrip)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, OpenSuccessfulBlocking)
{
    port = new ModbusAscOverTcpPortTestHelper(true);
...
TEST_F(ModbusAscOverTcpPortTest, OpenSuccessfulNonBlocking)
{
    port = new ModbusAscOverTcpPortTestHelper(false);
    port->setHost("127.0.0.1");
    port->setPort(1502);
...
TEST_F(ModbusAscOverTcpPortTest, CloseWhenNotOpen)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, HandleMethod)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, MultipleWriteBufferCalls)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, WriteWithDifferentDataSizes)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, WriteMethodWhenNotOpen)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, ReadMethodWhenNotOpen)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, WriteWhenNotOpen)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, ReadWhenNotOpen)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, WriteMethodWithValidData)
{
    port = new ModbusAscOverTcpPortTestHelper();
...
TEST_F(ModbusAscOverTcpPortTest, SocketWriteVariousFunctionCodes)
{
    port = new ModbusAscOverTcpPortTestHelper();

...
class ModbusUdpPortTestHelper : public ModbusUdpPort
{
public:
    ModbusUdpPortTestHelper(bool blocking = true) : ModbusUdpPort(blocking) {}
...
// Test Fixture for ModbusUdpPort
class ModbusUdpPortTest : public ::testing::Test
{
protected:
    ModbusUdpPortTestHelper *port;
...
TEST_F(ModbusUdpPortTest, InitializationDefault)
{
    port = new ModbusUdpPortTestHelper();
    
    EXPECT_EQ(port->type(), Modbus::UDP);
...
TEST_F(ModbusUdpPortTest, InitializationBlockingMode)
{
    ModbusUdpPortTestHelper *portBlocking = new ModbusUdpPortTestHelper(true);
    EXPECT_TRUE(portBlocking->isBlocking());
    delete portBlocking;

    ModbusUdpPortTestHelper *portNonBlocking = new ModbusUdpPortTestHelper(false);
    EXPECT_FALSE(portNonBlocking->isBlocking());
    EXPECT_TRUE(portNonBlocking->isNonBlocking());
    delete portNonBlocking;
}

TEST_F(ModbusUdpPortTest, InitializationBasic)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, HostConfiguration)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, PortConfiguration)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, TimeoutConfiguration)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, ServerModeConfiguration)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, OpenMethodClearsChangedFlag)
{
    auto *udpPort = new ModbusUdpPort(true);
    
    udpPort->setHost("somethingnonexisting.plc");
    EXPECT_TRUE(udpPort->isChanged());    
    auto status = udpPort->open();
    EXPECT_TRUE(Modbus::StatusIsBad(status));
    EXPECT_FALSE(udpPort->isChanged());    
    delete udpPort;
}
...
TEST_F(ModbusUdpPortTest, TransactionIdAutoIncrement)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, TransactionIdNoAutoIncrementInServerMode)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(true);
...
TEST_F(ModbusUdpPortTest, TransactionIdRepeatedRequest)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(false);
...
TEST_F(ModbusUdpPortTest, WriteBufferClientMode)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(false);
    ...
    // Expected size: 6 (MBAP header) + 1 (unit) + 1 (func) + 4 (data) = 12 bytes
    EXPECT_EQ(sz, 12);
...
TEST_F(ModbusUdpPortTest, WriteBufferServerMode)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(true);
    ...
    // Expected size: 6 (MBAP header) + 1 (unit) + 1 (func) + 3 (data) = 11 bytes
    EXPECT_EQ(sz, 11);
...
TEST_F(ModbusUdpPortTest, WriteBufferOverflow)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, ReadBufferClientMode)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(false);
...
TEST_F(ModbusUdpPortTest, ReadBufferServerMode)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(true);
...
TEST_F(ModbusUdpPortTest, ReadBufferTooSmall)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, ReadBufferInvalidProtocolId)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, ReadBufferIncorrectLength)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, ReadBufferTransactionMismatch)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(false);
...
TEST_F(ModbusUdpPortTest, OpenSuccessfulBlocking)
{
    port = new ModbusUdpPortTestHelper(true);
...
TEST_F(ModbusUdpPortTest, OpenSuccessfulNonBlocking)
{
    port = new ModbusUdpPortTestHelper(false);
    port->setHost("127.0.0.1");
    port->setPort(1502);
...
TEST_F(ModbusUdpPortTest, CloseWhenNotOpen)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, CompleteRequestResponseCycle)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(false);
...
TEST_F(ModbusUdpPortTest, ServerModeRequestResponseCycle)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(true);
...
TEST_F(ModbusUdpPortTest, MaximumDataSize)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, TypeMethod)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, HandleMethod)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, MultipleWriteBufferCalls)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(false);
...
TEST_F(ModbusUdpPortTest, ExceptionResponse)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(false);
...
TEST_F(ModbusUdpPortTest, DefaultSettings)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, BufferDataAccess)
{
    port = new ModbusUdpPortTestHelper();
    ...
    EXPECT_EQ(writeSize, 12); // 6 (MBAP header) + 1 (unit) + 1 (func) + 4 (data)
...
TEST_F(ModbusUdpPortTest, ZeroLengthData)
{
    port = new ModbusUdpPortTestHelper();
    ...
    EXPECT_EQ(sz, 8); // 6 (MBAP header) + 1 (unit) + 1 (func) + 0 (data)
}
...
TEST_F(ModbusUdpPortTest, WriteWhenNotOpen)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, ReadWhenNotOpen)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, WriteEmptyBuffer)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, ReadEmptyResponse)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, WriteBufferPreparedCorrectly)
{
    port = new ModbusUdpPortTestHelper();
    ...
    EXPECT_EQ(size, 12); // 6 MBAP header + 1 unit + 1 func + 4 data
...
TEST_F(ModbusUdpPortTest, ReadBufferSequence)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(true); // Server mode to accept any transaction ID
    
    // Simulate a complete MBAP response in internal buffer
    uint8_t responseData[11];
...
TEST_F(ModbusUdpPortTest, WriteReadCycle)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(false);
...
TEST_F(ModbusUdpPortTest, MultipleWriteCalls)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(false);
...
TEST_F(ModbusUdpPortTest, ReadPartialData)
{
    port = new ModbusUdpPortTestHelper();
    
    // Simulate partial response (incomplete MBAP frame)
...
TEST_F(ModbusUdpPortTest, WriteWithDifferentDataSizes)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, ReadBufferBoundaryConditions)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(true); // Server mode to accept any transaction ID
    
    // Test minimum valid MBAP frame (8 bytes)
    uint8_t minData[8];
...
TEST_F(ModbusUdpPortTest, VerifyMbapHeaderConstants)
{
    port = new ModbusUdpPortTestHelper();
    ...
    // Protocol ID must always be 0x0000 for Modbus UDP (MBAP)
...
TEST_F(ModbusUdpPortTest, WriteMethodWhenNotOpen)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, ReadMethodWhenNotOpen)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, WriteMethodWithValidData)
{
    port = new ModbusUdpPortTestHelper();
    
    // Prepare a valid Modbus UDP request
    uint8_t unit = 1;
    uint8_t func = MBF_READ_HOLDING_REGISTERS;
    ...
    // Verify buffer is prepared with MBAP header
    const uint8_t* buff = port->writeBufferData();
    EXPECT_EQ(buff[2], 0x00); // Protocol ID MSB
    EXPECT_EQ(buff[3], 0x00); // Protocol ID LSB
...
TEST_F(ModbusUdpPortTest, SocketWriteDataIntegrity)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, SocketReadResponseValidation)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(true); // Server mode for flexible transaction ID
    
    // Simulate a valid UDP response in the internal buffer
    uint8_t response[] = {
...
TEST_F(ModbusUdpPortTest, SocketWriteExceptionHandling)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, SocketReadExceptionResponse)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(true);
...
TEST_F(ModbusUdpPortTest, SocketWriteReadFullCycle)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, SocketWriteVariousFunctionCodes)
{
    port = new ModbusUdpPortTestHelper();
...
TEST_F(ModbusUdpPortTest, SocketReadDifferentResponseSizes)
{
    port = new ModbusUdpPortTestHelper();
    port->setServerMode(true);

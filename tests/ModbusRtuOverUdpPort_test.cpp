...
class ModbusRtuOverUdpPortTestHelper : public ModbusRtuOverUdpPort
{
public:
    ModbusRtuOverUdpPortTestHelper(bool blocking = true) : ModbusRtuOverUdpPort(blocking) {}
...
// Test Fixture for ModbusRtuOverUdpPort
class ModbusRtuOverUdpPortTest : public ::testing::Test
{
protected:
    ModbusRtuOverUdpPortTestHelper *port;
...
TEST_F(ModbusRtuOverUdpPortTest, InitializationDefault)
{
    port = new ModbusRtuOverUdpPortTestHelper();
    
    EXPECT_EQ(port->type(), Modbus::RTUvUDP);
...
TEST_F(ModbusRtuOverUdpPortTest, InitializationBlockingMode)
{
    ModbusRtuOverUdpPortTestHelper *portBlocking = new ModbusRtuOverUdpPortTestHelper(true);
    EXPECT_TRUE(portBlocking->isBlocking());
    delete portBlocking;

    ModbusRtuOverUdpPortTestHelper *portNonBlocking = new ModbusRtuOverUdpPortTestHelper(false);
    EXPECT_FALSE(portNonBlocking->isBlocking());
    EXPECT_TRUE(portNonBlocking->isNonBlocking());
    delete portNonBlocking;
}

TEST_F(ModbusRtuOverUdpPortTest, InitializationBasic)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, HostConfiguration)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, PortConfiguration)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, TimeoutConfiguration)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, ServerModeConfiguration)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, OpenMethodClearsChangedFlag)
{
    auto *rtuUdpPort = new ModbusRtuOverUdpPort(true);
    
    rtuUdpPort->setHost("somethingnonexisting.plc");
    EXPECT_TRUE(rtuUdpPort->isChanged());    
    auto status = rtuUdpPort->open();
    EXPECT_TRUE(Modbus::StatusIsBad(status));
    EXPECT_FALSE(rtuUdpPort->isChanged());    
    delete rtuUdpPort;
}
...
TEST_F(ModbusRtuOverUdpPortTest, WriteBufferConstructsCrcAndReturnsGood)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, WriteBufferReadHoldingRegisters)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, WriteBufferWriteSingleCoil)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, WriteBufferZeroLengthData)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, WriteBufferLargeData)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, WriteBufferOverflow)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, ReadBufferValidFrame)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, ReadBufferReadHoldingRegistersResponse)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, ReadBufferExceptionResponse)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, ReadBufferTooSmallFrame)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, ReadBufferWrongCrcRaises)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, ReadBufferMinimalValidFrame)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, CompleteRequestResponseCycle)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, CrcCalculationConsistency)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, DifferentDataSizesCrcValidation)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, DefaultSettings)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, OpenSuccessfulBlocking)
{
    port = new ModbusRtuOverUdpPortTestHelper(true);
...
TEST_F(ModbusRtuOverUdpPortTest, OpenSuccessfulNonBlocking)
{
    port = new ModbusRtuOverUdpPortTestHelper(false);
    port->setHost("127.0.0.1");
    port->setPort(1502);
...
TEST_F(ModbusRtuOverUdpPortTest, CloseWhenNotOpen)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, HandleMethod)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, MultipleWriteBufferCalls)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, WriteWithDifferentDataSizes)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, WriteMethodWhenNotOpen)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, ReadMethodWhenNotOpen)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, WriteWhenNotOpen)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, ReadWhenNotOpen)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, WriteMethodWithValidData)
{
    port = new ModbusRtuOverUdpPortTestHelper();
...
TEST_F(ModbusRtuOverUdpPortTest, SocketWriteVariousFunctionCodes)
{
    port = new ModbusRtuOverUdpPortTestHelper();

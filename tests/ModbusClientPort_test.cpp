...
TEST_F(ModbusClientPortTest, FrameRequestSuccess)
{
    ...
    memcpy(outBuff, inBuff, sizeof(inBuff));

    EXPECT_EQ(signalCounter.txCount, 0);
    EXPECT_EQ(signalCounter.rxCount,   0);

    StatusCode result = clientPort->frameRequest(unit, func, outBuff, sizeof(inBuff), sizeof(outBuff), &szOutBuff);
...
TEST_F(ModbusClientPortTest, FrameRequestNonBlocking)
{
    ...
    StatusCode result = clientPortNonBlock->frameRequest(unit, func, outBuff, sizeof(inBuff), sizeof(outBuff), &szOutBuff);
    ...
    memcpy(outBuff, inBuff, sizeof(inBuff));
    result = clientPortNonBlock->frameRequest(unit, func, outBuff, sizeof(inBuff), sizeof(outBuff), &szOutBuff);
    EXPECT_EQ(result, Status_Processing);
...
TEST_F(ModbusClientPortTest, FrameRequestPortBusyWithOtherClient)
{
    ...
    StatusCode result = clientPort->frameRequest(1, 0x41, outBuff, sizeof(inBuff), sizeof(outBuff), &szOutBuff);
